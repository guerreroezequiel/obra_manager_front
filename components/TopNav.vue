        ...
        <div class="flex">
            ...
            <div class="relative mr-6">
                ...
                <div v-if="showDropdowns['menu3']"
                    ...
                    <a href="http://localhost:3000/Modulos"
                        class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Modulos</a>
                    <a href="http://localhost:3000/Tareas"
