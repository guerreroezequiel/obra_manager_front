...
export default {
    ...
    setup(props, { emit }) {
        let consulta = ref<Proveedor[]>([]);
        let open = ref(true);
        let selected = ref<Proveedor | null>(null); // Nueva variable para almacenar el objeto ArtTarea seleccionado
        ...
        const deleteRowVisual = (rowToDelete: Proveedor) => {
