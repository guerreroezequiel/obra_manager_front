    ...
    setup(props, { emit }) {
        ...
        async function refreshData() {
            ...
            if (response.ok) {
                ...
                const camposResponse = await fetch(`http://localhost:3333/user_field_settings/table/uni_meds`);  // campos editables
        ...
        const deleteRows = async () => {
            ...
            for (let row of deletedRows.value) {
                ...
                try {
                    const response = await fetch(`http://localhost:3333/uni_meds/${row.id}`, {
                        method: 'DELETE',
                        headers: {
        ...
        const saveChanges = async () => {
            ...
            for (let id in itemsToUpdate) {
                ...
                const response = await fetch(`http://localhost:3333/uni_meds/${id}`, {
                    method: 'PUT', // 
                    headers: {
                        'Content-Type': 'application/json'
                    },
            ...
            for (let item of itemsToCreate) {
                ...
                const response = await fetch(`http://localhost:3333/uni_meds`, {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
